  ...
  return (
    ...
    >
      {isOpen ? (
        ...
        <div onClick={handleClosedRestaurant}>
          <img
            src={detail.image || "/img/default_rest_image.webp"}
            alt="restaurant"
            className="w-full h-[140px] rounded-md object-cover sm:h-32 md:h-44 lg:h-52 "
          ...
          <div className="absolute top-4 right-4">
            {isOpen ? (
              <h1 className="font-bold bg-green-500 text-white text-[12px] px-2 py-1 rounded-full">
                Open Now
              </h1>
            ) : (
              <h1 className="font-bold bg-red-500 text-white text-[12px] px-2 py-1 rounded-full">
                Closed
              </h1>
            )}
          </div>
